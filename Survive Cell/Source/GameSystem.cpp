...
,{ 710, 1325, 120, 35 },{ 920, 710, 170, 35 },{ 1090, 720, 850, 230	 },{ 1090, 1200, 850, 170 },{ 1530, 950, 410,250}
...
void GameSystem::SetGameOver(int setOverMode)
{
	isGameOver = true;
	overMode = setOverMode;
}
...
void GameSystem::CreatStage1Object()
{
	...
	AddGameObject(new Demon("Monster", 1400, 1010, 110, 158));
	AddGameObject(new Demon("Monster", 1200, 415, 110, 158));
	AddGameObject(new Demon("Monster", 1425, 10, 110, 158));
	AddGameObject(new Demon("Monster", 1920, 200, 110, 158));
	AddGameObject(new Demon("Monster", 2150, 1370, 110, 158));
	AddGameObject(new Demon("Monster", 2700, 1290, 110, 158));
	AddGameObject(new Demon("Monster", 2950, 1290, 110, 158));
	AddGameObject(new Demon("Monster", 2200, 40, 110, 158));


	AddUserInterface(new EquipedSlot("EquipedSlot", SIZE_X / 10 - 100, SIZE_Y * 9 / 10, 64, 60, 0));
	AddUserInterface(new EquipedSlot("EquipedSlot", SIZE_X / 10 - 10, SIZE_Y * 9 / 10, 64, 60, 1));
