...
namespace game_framework {
	...
	void CGameStateInit::OnInit()
	{
		...
		GameSystem::AddGameObject((new Monster("Monster", SIZE_X / 2 - 30, SIZE_Y / 2 - 100 , 10, 10, IDB_0)));
		GameSystem::AddGameObject((new Monster("Monster", SIZE_X / 2 + 30, SIZE_Y / 2 - 100, 10, 10, IDB_1)));
